...
@section('Hotel Room', 'active menu-item-open')
@section('content')
    <div class="card card-custom">
        <div class="card-header flex-wrap border-0 pt-3 pb-0">
            <div class="card-title">
                <h3 class="card-label">Hotel Room
                </h3>
                <p>Manage Hotel Room</p>
            </div>
            <div class="card-toolbar">

                <a href="{{ route('hotel-room.create', $hotelId) }}" class="btn btn-primary font-weight-bolder">
                    + Add Room</a>
                        ...
                        <tbody>
                            @foreach ($roomTypes as $room)
                                <tr>
                                    ...
                                    <td><img src="{{ asset($room->photo_url) }}" alt="Image" style="height: 60px;" />
                                    </td>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ route('hotel-room.edit', ['hotelId' => $hotelId, 'id' => $room->id]) }}"
                                            class="btn btn-sm text-primary border-0" data-bs-toggle="tooltip"
                                            title="Edit">
                                            <i class="la la-edit"></i>
                                        </a>
                                        <form
                                            action="{{ route('hotel-room.destroy', ['hotelId' => $hotelId, 'id' => $room->id]) }}"
