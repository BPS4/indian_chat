    ...
    <div class="card card-custom">
        <div class="card-header flex-wrap border-0 pt-3 pb-0">
            <div class="card-title">
                <h3 class="card-label">Locality </h3>
                <p>Manage Locality</p>
            </div>
            <div class="card-toolbar">

                <a href="{{ route('locality.addForm') }}" class="btn btn-primary font-weight-bolder">
                    + Add Locality</a>
            ...
            <form method="GET" action=" ">
                <div class="card-search mb-5">
                    <div class="w-75 position-relative">
                        ...
                        <input class="form-control ps-25" type="search" placeholder="Search by title"
                            ...
                            @foreach ($localities as $locality)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ route('locality.editForm', $locality->id) }}"
                                        ...
                                        <form action="{{ route('locality.destroy', $locality->id) }}" method="POST"
                                            ...
                                            onsubmit="return confirm('Are you sure you want to delete this locality?');">
                                            @csrf
                                            @method('DELETE')
