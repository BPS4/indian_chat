    ...
    <div class="card card-custom">
        <div class="card-header flex-wrap border-0 pt-3 pb-0">
            ...
            <div class="card-toolbar">
                ...
                <a href="{{ route('location.addForm') }}" class="btn btn-primary font-weight-bolder">
                    + Add Location</a>
                ...
                <div class="card-search mb-5">
                    <div class="w-75 position-relative">
                        ...
                        <input class="form-control ps-25" type="search" placeholder="Search by title"
                            aria-label="Search" type="search" name="search" value="{{ request('search') }}">
                    </div>
                        ...
                        <tbody>
                            @foreach ($locations as $location)
                                <tr>
                                    ...
                                    <td><img src="{{ asset($location->image) }}" alt="Image" style="height: 60px" /></td>
                                    <td>{{ $location->city }}</td>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ route('location.editForm', $location->id) }}"
